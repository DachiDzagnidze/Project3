...
const questions = [
    {
        ...
        image: "/16Q/16-question quize img/Q16.png", 
        options: [
            "/16Q/16-question quize img/Q16-01.png", 
            "/16Q/16-question quize img/Q16-02t.png", 
            "/16Q/16-question quize img/Q16-03.png", 
            "/16Q/16-question quize img/Q16-04.png", 
            "/16Q/16-question quize img/Q16-05.png", 
            "/16Q/16-question quize img/Q16-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers16Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/17Q/index.html"; // Update to the appropriate path
    }
}
