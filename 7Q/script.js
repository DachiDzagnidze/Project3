...
const questions = [
    {
        ...
        image: "/7Q/07-question quize img/Q7.png", 
        options: [
            "/7Q/07-question quize img/Q7-01.png", 
            "/7Q/07-question quize img/Q7-02.png", 
            "/7Q/07-question quize img/Q7-03t.png", 
            "/7Q/07-question quize img/Q7-04.png", 
            "/7Q/07-question quize img/Q7-05.png", 
            "/7Q/07-question quize img/Q7-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers7Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/8Q/index.html"; // Update to the appropriate path
    }
}
