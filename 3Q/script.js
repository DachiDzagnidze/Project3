...
const questions = [
    {
        ...
        options: [
            ...
            "/3Q/03-question quize img/Q3-02t.png", 
            "/3Q/03-question quize img/Q3-03.png", 
            "/3Q/03-question quize img/Q3-04.png", 
            "/3Q/03-question quize img/Q3-05.png", 
            "/3Q/03-question quize img/Q3-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers3Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/4Q/index.html"; // Update to the appropriate path
    }
}
