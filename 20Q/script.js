...
const questions = [
    {
        ...
        options: [
            ...
            "/20Q/20-question quize img/Q20-02.png", 
            "/20Q/20-question quize img/Q20-03t.png", 
            "/20Q/20-question quize img/Q20-04.png", 
            "/20Q/20-question quize img/Q20-05.png", 
            "/20Q/20-question quize img/Q20-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers20Q', JSON.stringify(answers)); // Store answers in local storage
