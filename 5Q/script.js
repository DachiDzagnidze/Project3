...
const questions = [
    {
        image: "/5Q/05-question quize img/Q5.png", 
        options: [
            "/5Q/05-question quize img/Q5-01.png", 
            "/5Q/05-question quize img/Q5-02.png", 
            "/5Q/05-question quize img/Q5-03.png", 
            "/5Q/05-question quize img/Q5-04.png", 
            "/5Q/05-question quize img/Q5-05t.png", 
            "/5Q/05-question quize img/Q5-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers5Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/6Q/index.html"; // Update to the appropriate path
    }
}
