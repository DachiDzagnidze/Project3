...
const questions = [
    {
        ...
        image: "/12Q/12-question quize img/Q12.png", 
        options: [
            "/12Q/12-question quize img/Q12-01t.png", 
            "/12Q/12-question quize img/Q12-02.png", 
            "/12Q/12-question quize img/Q12-03.png", 
            "/12Q/12-question quize img/Q12-04.png", 
            "/12Q/12-question quize img/Q12-05.png", 
            "/12Q/12-question quize img/Q12-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers12Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/13Q/index.html"; // Update to the appropriate path
    }
}
