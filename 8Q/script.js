...
const questions = [
    {
        image: "/8Q/08-question quize img/Q8.png", 
        options: [
            "/8Q/08-question quize img/Q8-01t.png", 
            "/8Q/08-question quize img/Q8-02.png", 
            "/8Q/08-question quize img/Q8-03.png", 
            "/8Q/08-question quize img/Q8-04.png", 
            "/8Q/08-question quize img/Q8-05.png", 
            "/8Q/08-question quize img/Q8-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers8Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/9Q/index.html"; // Update to the appropriate path
    }
}
