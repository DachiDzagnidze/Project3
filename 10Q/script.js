...
const questions = [
    {
        ...
        options: [
            ...
            "/10Q/10-question quize img/Q10-02.png", 
            "/10Q/10-question quize img/Q10-03.png", 
            "/10Q/10-question quize img/Q10-04.png", 
            "/10Q/10-question quize img/Q10-05t.png", 
            "/10Q/10-question quize img/Q10-06.png"
        ],
...
function submitAnswer() {
    ...
    if (selectedAnswer) {
        ...
        localStorage.setItem('quizAnswers10Q', JSON.stringify(answers)); // Store answers in local storage
...
function nextQuestion() {
    ...
    if (currentQuestionIndex < questions.length) {
        ...
        window.location.href = "/11Q/index.html"; // Update to the appropriate path
    }
}
